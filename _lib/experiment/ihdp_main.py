...
def train_and_predict_dragons(t, y_unscaled, x, targeted_regularization=True, output_dir='',
    ...
    np.random.seed(i)
    train_index, test_index = train_test_split(np.arange(x.shape[0]), test_size=1, random_state=1)
...
def main():
    ...
    parser.add_argument('--data_base_dir', type=str, default= 'C:/Users/qumuzi18/Desktop/gil-main/data/ihdp/csv/', help="path to directory LBIDD")
    parser.add_argument('--knob', type=str, default='dragonnet',
                        help="dragonnet or tarnet or nednet")

    parser.add_argument('--output_base_dir', type=str, default= 'C:/Users/qumuzi18/Desktop/gil-main/output/ihdp/', help="directory to save the output")
