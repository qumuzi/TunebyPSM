...
def load_truth(replication, knob):
    ...
    file_path = 'C:/Users/qumuzi18/Desktop/gil-main/output/ihdp/{}/{}/simulation_outputs.npz'.format(knob, replication)
    data = load(file_path)
    mu_0 = data['mu_0']
    mu_1 = data['mu_1']
...
def load_data(knob='default', replication=1, model='baseline', train_test='test'):
    ...
    file_path = 'C:/Users/qumuzi18/Desktop/gil-main/output/ihdp/{}/'.format(knob)
